...
import DeterminFuzzySets from '@components/DetermineFuzzySets';
        ...
        {showSteps &&
          <>
            ...
            <div>
              ...
              <DeterminFuzzySets dataIsSet={dataIsSet} temperature={formData.temperature} water={formData.water} steps={formData.steps}/>
            </div>
            <div>
              <h2 id='step-3'>
